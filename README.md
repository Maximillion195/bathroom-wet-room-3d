# Bathroom wet room — 3D model

Export from Sweet Home 3D for sharing / viewing online.

## View in [3dviewer.net](https://3dviewer.net)

1. Open https://3dviewer.net
2. Click **Open URL**
3. Paste these links (one per line):
...
Or download `bathroom-3d.zip` and drag it onto 3dviewer.net.
